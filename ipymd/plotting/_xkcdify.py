...
def _XKCDify(ax, mag=1.0,
    ...
    for line in lines:
        ...
        x_int, y_int = _xkcd_line(x, y, xlim, ylim,
                                 mag, f1, f2, f3)
    ...
    fontpath = get_data_path('Humor-Sans.ttf',module=fonts)
    prop = fm.FontProperties(fname=fontpath, size=16)
    ...
    if leg is not None:
        ...
        for child in leg.get_children():
            if isinstance(child, plt.Line2D):
                x, y = child.get_data()
                child.set_data(_xkcd_line(x, y, mag=10, f1=100, f2=0.001))
